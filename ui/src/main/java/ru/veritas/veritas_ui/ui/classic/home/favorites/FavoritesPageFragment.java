...
public class FavoritesPageFragment extends Fragment {
    ...
    public static FavoritesPageFragment newInstance(int pageIndex, int columnCount, GetAppIconUseCase getAppIconUseCase, OpenSettingsUseCase openSettingsUseCase) {
        FavoritesPageFragment fragment = new FavoritesPageFragment();
        fragment.getAppIconUseCase = getAppIconUseCase;
        fragment.openSettingsUseCase = openSettingsUseCase;
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE_INDEX, pageIndex);
        args.putInt(ARG_COLUMN_COUNT, columnCount);
        fragment.setArguments(args);
